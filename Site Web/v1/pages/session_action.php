...
if ($_POST["pseudo"] && $_POST["mdp"]){
    ...
    /* 1) Requête SQL n° 1) incomplète de recherche du compte utilisateur à partir des pseudo / mot de passe saisis */
    ...
    /* Exécution de la requête pour vérifier si le compte (=pseudo+mdp) existe !*/
