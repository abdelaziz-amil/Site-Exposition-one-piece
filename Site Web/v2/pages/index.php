...
<div class="bgded overlay padtop" style="background-image:url('../images/demo/backgrounds/01.png');"> 
  ...
  <div id="pageintro" class="hoc clear"> 
    ...
    $mysqli = new mysqli('localhost','zamilab00','XXXXX','zfl2-zamilab00');
        ...
        $requete="SELECT * FROM T_CONFIGURATION_CON;";//recuperation des informations de la configuration dans la base
...
<div class="wrapper row2">
  <section class="hoc container clear"> 
    ...
    $requete="SELECT * FROM T_ACTUALITE_ACT;";//recuperation de toutes les actualités dans la base pour les afficher dans un tableau
